/* OLTE App — sprite ikon.
   ŹRÓDŁO: lucide-static@1.27.0 (oficjalny pakiet Lucide), geometria 1:1 — nie przerysowywana.
   Każde id sprite'u = dokładna nazwa ikony w Lucide, więc "#i-<nazwa-lucide>" jest jedynym
   sposobem dodania ikony. Nowa ikona = nowy wpis pobrany z Lucide, nigdy rysunek odręczny.
   Wstrzykiwany synchronicznie na początku <body>, więc <use href="#i-*"> znajduje cel
   jeszcze przed sparsowaniem reszty dokumentu. */
(function () {
  var I = {
    /* nawigacja i chrome */
  ...
  var out = '<svg aria-hidden="true" focusable="false" style="position:absolute;width:0;height:0;overflow:hidden">';
  for (var k in I) {
    out += '<symbol id="i-' + k + '" viewBox="0 0 24 24" fill="none" stroke="currentColor" ' +
           'stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' + I[k] + '</symbol>';
  }
  out += '</svg>';
